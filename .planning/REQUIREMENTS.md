...
- [ ] **FPF-05**: Skill knows major FPF programs (Center for AI, Youth Privacy, Privacy Papers for Policymakers, DC Privacy Forum, Training Program)
...
- [ ] **ORG-04**: Source attribution appears in every answer with organization name and ideally URL
...
- [ ] **ARCH-06**: Professional-grade language assumes domain knowledge, uses precise legal/regulatory terminology
- [ ] **ARCH-07**: Anti-hallucination instructions embedded; regulatory facts come from reference files, not training data
- [ ] **ARCH-08**: Legal disclaimer in every output pathway stating skill assists research, not legal advice
